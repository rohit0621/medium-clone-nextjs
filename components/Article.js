      ...
      <div key={article.id} className="p-6 flex justify-between space-x-4">
       <div>
          <div className='flex gap-2'>
              <img alt="img" className='rounded-full w-5 h-5' src={article.avatarurl}></img>
          ...
          <div className='flex justify-between items-center mt-2.5'>
             ...
             <div className="w-1 h-1 bg-gray-500 rounded-full"></div>
              <p className='text-gray-500 text-sm'>{article.readtime} min read</p>
              <div className="w-1 h-1 bg-gray-500 rounded-full"></div>
              <div className='bg-gray-200 px-2 py-1 rounded-full'><p className='text-gray-500 text-sm'>{article.category}</p></div>
             </div>
